...
import com.sencha.gxt.dnd.core.client.TreeDropTarget.TreeDropTargetResources;
...
public class TreeDropTarget<M> extends DropTarget {
  ...
  protected boolean autoExpand = true, autoScroll = true;
  private int autoExpandDelay = 800;
  protected boolean restoreTrackMouse;
  protected boolean addChildren;
  protected AutoScrollSupport scrollSupport;
