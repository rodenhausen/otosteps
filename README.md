...
#### Arguments
`-remoteUI "${gwt_remote_ui_server_port}:${unique_id}" -startupUrl index.html -logLevel INFO -port auto -codeServerPort auto -war **full_path_to_your_git_dir**\oto2\oto\target\oto-0.0.1-SNAPSHOT edu.arizona.biosemantics.oto2.oto.Oto`
